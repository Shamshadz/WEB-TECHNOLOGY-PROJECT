...
const Eligibility = () => {
  return (
    ...
    >
      ...
      <p className={`mt-2 ${bodyText.className}`}>
        Students who studied as the main subject in 12th standard of
        schooling can opt. Also students who have taken Business Studies and
        Accountancy in PUC or equivalent 12th std examinations are eligible to
        apply. Science students with Mathematics are also eligible.{" "}
      </p>
    </div>
  );
};
  ...
  return (
    <div id="apply-btn">
      <Link
        ...
        className="relative inline-flex items-center justify-start py-3.5 pl-4 pr-12 overflow-hidden font-semibold text-blue-900 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group"
      >
